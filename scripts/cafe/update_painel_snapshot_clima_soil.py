...
def main():
    ...
    rule_txt = """Este indicador mede o nivel de estresse hidrico do solo nas principais regioes produtoras de cafe.
    ...
    momento em que variacoes passam a ter impacto relevante sobre a oferta.
