...
def main():
    ...
    rule_txt = (
    "Este indicador mede o nível de estresse hídrico do solo nas principais regiões produtoras de café. "
    "Valores mais altos indicam solo mais seco, o que pode reduzir a produtividade. "
    "O painel avalia o nível do estresse em relação ao histórico e só gera sinal de tendência quando a seca "
    "atinge níveis extremos, momento em que variações passam a ter impacto relevante sobre a oferta. "
    "Fora desses episódios, o clima é considerado neutro para a análise direcional."
    )
