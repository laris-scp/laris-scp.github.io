...
# CONFIG
# =========================
TICKER = "ZS=F"  # Soja CBOT (Soybean Futures)
MM_LONG = 252
MM_SHORT = 50
LEVEL_YEARS = 10

OUT_PATH = Path("data/soja/series/preco_soja.json")

META = {
    "id": "preco_soja",
    "name": "PREÇO SOJA",
    "unit": "US¢/bu",  # cents por bushel
    "frequency": "Diária",
}
...
def get_close_series(df: pd.DataFrame) -> pd.Series:
    if df is None or df.empty:
        raise RuntimeError(f"Yahoo retornou vazio para {TICKER}.")
...
def main():
    ...
    print("OK: preco_soja.json atualizado.")
